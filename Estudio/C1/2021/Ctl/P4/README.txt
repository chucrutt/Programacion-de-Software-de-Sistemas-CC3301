...
Programe su solucion en el archivo leeritemes.c.  Ya hay una plantilla en
leeritemes.c.plantilla.
...
leerItemes para determinar con que parámetros no funcionaron.
...
A sanitize no le gusta correr bajo ddd/gdb.  Si después de terminar
