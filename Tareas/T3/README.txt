...
Ud. debe crear el archivo intervalo.c y programar ahí la función
solicitada.
...
+ make run-san debe felicitarlo y no debe reportar ningún problema como
  por ejemplo accesos invalidos a memoria.
...
archivo intervalo.zip que contiene intervalo.c, con su solución,
...
Entregue por U-cursos el archivo intervalo.zip
